...
Stephen Few noted in \italize{Information Dashboard Design: The effective visual communication of data} the following:
\begin{quotation}
...
Few outlined common mistakes that are made in \italize{Information Dashboard Design}, we will focus on making sure that the following three common mistakes are avoided to make sure that the town analyst have the best path to success:
\begin{itemize}
