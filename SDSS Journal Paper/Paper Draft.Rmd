...
<!-- Should we use the idea of the "sense making framework here or the NOvice model" to understand if the user is actually get what we want them to get from the app? This may not be GDL but this can help us use the data in a way that will be useful. -->
