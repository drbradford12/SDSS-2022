...
Using an exploratory methodology, we collected open source data from the Iowa Data Gov website to understand the  

we derived a design space consisting of 3-4 visual and functional aspects of dashboards with statistical exploratory data analysis. see Section~\ref{info-on-sections}.
